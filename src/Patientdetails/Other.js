               ...
               <Typography className="patient" variant="h4">{data.head}</Typography><br/>
                 <label>{data.label}</label>
                     ...
                     <RadioGroup>
                        ...
                        <Link to="/someone"><FormControlLabel className="active" label={data.otherUser} control={<Radio />} value={data.otherUser}/></Link>
                     </RadioGroup>
                     ...
                     <TextField fullWidth variant="outlined" type="number" value={data.Othernumber}></TextField><br/><br/>
